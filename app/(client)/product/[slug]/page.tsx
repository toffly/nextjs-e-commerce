...
const page = async ({ params }: { params: Promise<{ slug: string }> }) => {
  ...
  return (
    <div className="container py-10">
        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
          ...
          <div className="space-y-2 border-t border-b border-gray-200 py-5">
            <PriceView
              ...
              className="text-lg font-boldb"
            />
            <p
              className={`px-4 py-1.5 inline-block text-center text-sm font-semibold rounded-lg ${product?.stock === 0 ? "bg-red-100 text-red-600" : "text-green-600 bg-green-100"}`}
            >
      ...
      <div className="w-full md:w-2/3 gap-5 py-10">
        <ProductDetailsTab/>
      </div>
    </div>
  );
